...
class Orders_model extends CI_Model 
{
	...
	*/
	...
	public function add_order_receivables($project_id,$nursery_id,$ctn_id)
	{
		$quantity_given = $this->input->post('fruit_trees') + $this->input->post('indegenous_trees') + $this->input->post('exotic_trees');
		$arrayName = array(
							'project_id' => $project_id,
							'nursery_id' => $nursery_id,
							'ctn_id' => $ctn_id,
							...
							'driver_national_id' => $this->input->post('driver_national_id'),
							'date_given' => $this->input->post('date_given'),
							'personnel_id' => $this->input->post('personnel_id'),
							'vehicle_number_plate' => $this->input->post('vehicle_number_plate'),
							'created' => date('Y-m-d'),
							'created_by' => $this->session->userdata('personnel_id')
						  );
