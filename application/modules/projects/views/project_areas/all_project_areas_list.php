<?php
		...
		if ($project_areas->num_rows() > 0)
		{
			...
			foreach ($project_areas->result() as $row)
			{
				...
				if($project_area_status == 0)
				{
					...
					$button = '<a class="btn btn-info btn-sm" href="'.site_url().'tree-planting/activate-area-location/'.$project_area_id.'" onclick="return confirm(\'Do you want to activate '.$project_area_name.'?\');" title="Activate '.$project_area_name.'"><i class="fa fa-thumbs-up"></i></a>';
				}
				//create activated status display
				else if($project_area_status == 1)
				{
					$status = '<span class="label label-success">Active</span>';
					$button = '<a class="btn btn-default btn-sm" href="'.site_url().'tree-planting/deactivate-area-location/'.$project_area_id.'" onclick="return confirm(\'Do you want to deactivate '.$project_area_name.'?\');" title="Deactivate '.$project_area_name.'"><i class="fa fa-thumbs-down"></i></a>';
				}
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				?>
		            ...
		            <?php echo form_open_multipart('import/import-watersheds', array("class" => "form-horizontal", "role" => "form"));?>
				...
				<div class="panel-body">
					<div class="row" style="margin-bottom:20px;">
            			<div class="col-lg-12 col-sm-12 col-md-12">
            				<div class="row">
            				<?php 
            						echo form_open("gbm-administration/add-project-area", array("class" => "form-horizontal", "role" => "form"));
