    ...
    <div class="panel-body">
    	...
    	<div class="row">
    		...
    		<div class="col-md-4">
    			<section class="panel">
					...
					<div class="panel-footer panel-footer-btn-group text-center" >
						<a href="<?php echo site_url();?>tree-planting/area-locations/<?php echo $project_id?>" ><i class="fa fa-folder-open mr-xs"></i> Project Watersheds</a>
					</div>
				</section>
    		</div>
    		<div class="col-md-4">
    			<section class="panel">
					...
					<div class="panel-footer panel-footer-btn-group text-center" >
						<a  href="<?php echo site_url();?>tree-planting/trainings/<?php echo $project_id;?>" ><i class="fa fa-folder-open mr-xs"></i> Meetings / Training</a>
					</div>
				</section>
    		</div>
    		<div class="col-md-4">
    			<section class="panel">
					...
					<div class="panel-footer panel-footer-btn-group text-center" >
						<a  href="<?php echo site_url();?>tree-planting/community-groups/<?php echo $project_id;?>" ><i class="fa fa-folder-open mr-xs"></i> Commmunity / Nursery  Groups</a>
					</div>
				</section>
    		</div>
    		<div class="col-md-4">
    			<section class="panel">
					...
					<div class="panel-footer panel-footer-btn-group text-center" >
						<a href="<?php echo site_url();?>tree-planting/seedling-production/<?php echo $project_id;?>" ><i class="fa fa-folder-open mr-xs"></i>Seedling Production</a>
					</div>
				</section>
    		</div>
    		<div class="col-md-4">
    		...
    		<div class="col-md-4">
    			<section class="panel">
					<header class="panel-heading bg-info">
						<h5 class="text-weight-semibold mt-sm text-center">STEP SIX :</strong> SITE PREPARATION</h5>
					</header>
					<div class="panel-body text-center">
						<p class="text-center">Total Community groups (<?php echo $totol_communities;?>)</p>
...
<div class="row">
	<div class="col-md-6">
		<section class="panel">
			<div class="panel-body">
				<?php
					$nursery_queries = $this->project_areas_model->get_project_areas_nurseries($project_id);
					$parameters3 = '';
	...
	<div class="col-md-6">
		<section class="panel">
			<div class="panel-body">
					...
					$ctn_query = $this->project_areas_model->get_project_ctn($project_id);
