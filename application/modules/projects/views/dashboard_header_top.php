	...
	<div class="col-md-12">
		<div class="panel-body center-align">
			<div class="col-md-2" style="margin:0 auto;">
				<span ><strong>TREE PLANTING </strong> </span>
			</div>
			<div class="col-md-10">
				<div class="col-md-3">
					<div class="h4 text-weight-bold mb-none"><?php echo $total_projects;?></div>
				...
				<div class="col-md-3">
					...
					<p class="text-xs text-muted mb-none">Meetings Done</p>
				</div>
				<div class="col-md-3">
					<div class="h4 text-weight-bold mb-none"><?php echo $totol_communities;?> | <?php echo $total_communities_members;?></div>
					<p class="text-xs text-muted mb-none">Community Groups | Members</p>
				...
				<div class="col-md-3">
					<div class="h4 text-weight-bold mb-none"><?php echo $totol_communities;?> | <?php echo $total_communities_members;?></div>
					<p class="text-xs text-muted mb-none">Men | Women Hired</p>
				</div>
				<div class="col-md-3">
					<div class="h4 text-weight-bold mb-none">48/200</div>
					<p class="text-xs text-muted mb-none">Planted / Surviving Trees</p>
...
<div class="row" style="margin-top:9px;">
	<div class="col-md-12">
		<div class="panel-body center-align">
			<div class="col-md-2" style="margin:0 auto;">
				<span ><strong>GENDER LIVELIHOODS & ADVOCACY </strong> </span>
			</div>
			<div class="col-md-10">
				<div class="col-md-2">
					<div class="h4 text-weight-bold mb-none"><?php echo $total_projects;?></div>
					<p class="text-xs text-muted mb-none">Total Forms Filled</p>
...
<div class="row" style="margin-top:9px;">
	<div class="col-md-12">
		<div class="panel-body center-align">
			<div class="col-md-2" style="margin:0 auto;">
				<span ><strong>CLIMATE CHANGE </strong> </span>
			</div>
			<div class="col-md-10">
				<div class="col-md-2">
					<div class="h4 text-weight-bold mb-none"><?php echo $total_projects;?></div>
